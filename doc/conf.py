...
project = u'python-errata-tool'
copyright = u'Copyright (C) 2016  Red Hat, Inc.'
author = u'Ken Dreyer'
...
htmlhelp_basename = 'errata-tooldoc'
...
latex_documents = [
    (master_doc, 'errata-tool.tex', u'errata-tool Documentation',
     u'Ken Dreyer', 'manual'),
]
...
man_pages = [
    (master_doc, 'errata-tool', u'errata-tool Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'errata-tool', u'errata-tool Documentation',
     author, 'errata-tool', 'Python API for Red Hat Errata Tool.',
     'Miscellaneous'),
]
